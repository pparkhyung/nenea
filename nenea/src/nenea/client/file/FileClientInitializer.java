...
public class FileClientInitializer extends ChannelInitializer<SocketChannel> {
	...
	private static final FileClientHandler FILe_CLIENT_HANDLER = new FileClientHandler();
	...
	public void initChannel(SocketChannel ch) {
		 ...
		 * TelnetClient.HOST, TelnetClient.PORT)); }
		 */
		 ...
		 * Delimiters.lineDelimiter())); pipeline.addLast(DECODER);
